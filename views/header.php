<header class="fixed top-0 inset-x-0 bg-white z-[500] shadow-md">
    <div class="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4 py-8 flex justify-between items-center">
        ...
        <div class="relative">
            ...
            if (isset($_SESSION['user'])) {
                $user = $_SESSION['user'];
                $userImage = isset($user['image']) && !empty($user['image']) ? $user['image'] : 'https://dovercourt.org/wp-content/uploads/2019/11/610-6104451_image-placeholder-png-user-profile-placeholder-image-png.jpg';
                echo '
                <div class="flex items-center cursor-pointer" id="user-profile" onclick="toggleDropdown()">
                    <img src="/QuizLand/' . $userImage . '" alt="صورة المستخدم" class="w-8 h-8 rounded-full object-cover ml-2">
    ...
    <div id="mobile-menu"
        ...
        <div class="flex flex-col items-center py-4 space-y-4">
            ...
            <a href="/QuizLand/views/home/quizzes.php" class="text-gray-700 hover:text-blue-500">الاختبارات</a>
            <a href="/QuizLand/views/about" class="text-gray-700 hover:text-blue-500">من نحن</a>
