...
$questionsQuery = "SELECT * FROM questions WHERE quiz_id = $quiz_id AND difficulty = '$difficulty' ORDER BY RAND() LIMIT $num_questions";
...
<body>
    ...
    <div class="quiz-container">
        ...
        <form id="sub-quiz" action="submit-quiz.php" method="POST">
                ...
                <?php foreach ($questions as $index => $question): ?>
                    <div class="question-container">
                        ...
                        <div>
                            ...
                            <?php
                            $answersQuery = "SELECT * FROM answers WHERE question_id = " . $question['id'] . " ORDER BY RAND()";
    ...
    <script>
        if (sessionStorage.getItem("quiz_started")) {
            window.location.href = "./quiz-details.php?quiz_id=<?= $quiz_id ?>";
        ...
        document.getElementById('sub-quiz').addEventListener('submit', () => {
            sessionStorage.removeItem("quiz_started");
        });
