...
<body class="bg-white">
  ...
  <div class="flex flex-col items-center justify-center min-h-screen py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="text-center mb-14">
      <img src="../../assets/images/logo/logo.svg" width="250" alt="شعار الموقع">
    </div>

    <!-- أزرار تسجيل الدخول الاجتماعي (اختياري) -->
    <div class="flex gap-8 justify-between md:w-1/3">
      <button
        class="flex md:w-[45%] items-center justify-center gap-2.5 rounded-lg p-3.5 bg-blue-600 hover:bg-blue-700 text-white border border-blue-600 hover:text-white transition-all duration-300 ease-in-out">
        تسجيل الدخول
        <!-- أيقونة Google -->
        <svg width="23" height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <defs><clipPath id="clip0_709_8846"><rect width="22" height="22" fill="white" transform="translate(0.5)"/></clipPath></defs>
        </svg>
      </button>
    ...
    <div class="mb-4">
      <a href="#" class="text-base text-gray-900 hover:text-blue-600">هل نسيت كلمة المرور؟</a>
    </div>

    <p class="text-base text-gray-900">
      ليس لديك حساب؟ <a href="./signup.php" class="text-blue-600 hover:underline">إنشاء حساب</a>
    </p>
  </div>
